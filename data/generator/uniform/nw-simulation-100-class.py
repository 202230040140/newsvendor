...
sio.savemat('data/uniform/IndexX-nw-10000-103-class.mat', mdict={'IndexX': ind})
sio.savemat('data/uniform/IndexY-nw-10000-103-class.mat', mdict={'IndexY': indt})

sio.savemat('data/uniform/TrainX-nw-10000-103-class.mat', mdict={'trainX': X})
sio.savemat('data/uniform/TrainY-nw-10000-103-class.mat', mdict={'trainY': y})
sio.savemat('data/uniform/TestX-nw-10000-103-class.mat', mdict={'testX': Xt})
sio.savemat('data/uniform/TestY-nw-10000-103-class.mat', mdict={'testY': yt})
